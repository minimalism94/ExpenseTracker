...
public class SubscriptionController {
    ...
    @PostMapping("/add")
    public ModelAndView addPayment(@Valid @ModelAttribute("subscription") SubscriptionDto dto, BindingResult bindingResult, @AuthenticationPrincipal UserData userData) {
        User user = userService.getById(userData.getUserId());
        List<Subscription> subscriptions = subscriptionService.getByUsername(user.getUsername());
        ModelAndView modelAndView = new ModelAndView("subscriptions");
        modelAndView.addObject("user", user);
        ...
        subscriptionService.saveSubscription(dto, user.getUsername());
